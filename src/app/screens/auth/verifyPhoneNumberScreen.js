      ...
      <ScrollView style={{}}>
        <View style={{ width: '90%', marginLeft: '5%', height: '100%', flexDirection: 'column', alignItems: 'flex-start', marginBottom: 30 }}>
          ...
          <View style={{ width: '100%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginBottom: 30 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: 30, gap: 3 }}>
              <Text style={{ color: '#5A5A5A', fontSize: 19 }}>
                Enter the 4 - digit code sent
              </Text>
              <Text style={{ color: '#5A5A5A', maxWidth: 250, textAlign: 'center', fontSize: 19 }}>
                to +91******8799
              </Text>
            </View>
          </View>
          <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '90%', marginLeft: '5%', marginTop: 35, gap: 25 }}>
            <View style={{ backgroundColor: '#fff', height: 50, borderRadius: 10, width: '100%', flexDirection: 'column', alignItems: 'center', borderWidth: 1, borderColor: '#00936A' }}>
              <TextInput
            ...
            <View style={{ flexDirection: 'column', alignItems: 'center', width: '95%', marginLeft: '2.5%', gap: 20 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', gap: 8 }}>
                <Text style={{ color: '#919396', fontSize: 14 }}>
                  Didn’t receive verification code ? Resend in
                </Text>
                <Text style={{ color: '#00936A', fontSize: 14, fontWeight: 'bold' }}>
                  02:00
                </Text>
              </View>
              <Image
